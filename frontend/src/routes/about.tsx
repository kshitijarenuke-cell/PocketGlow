  ...
  return (
    <SiteLayout>
      <section className="mx-auto max-w-4xl px-6 md:px-8 pt-24 pb-20 text-center">
        ...
        <p className="mt-8 max-w-2xl mx-auto text-base md:text-lg text-ink/80 leading-relaxed">
      ...
      <section className="mx-auto max-w-7xl px-6 md:px-8 pb-32 grid md:grid-cols-3 gap-8 text-center">
        {[
          ...
          <div key={b.t} className="rounded-3xl bg-beige p-10">
            <div className="font-display text-3xl mb-3">{b.t}</div>
            <p className="text-sm text-ink/80">{b.d}</p>
          </div>
        ))}
      </section>
    </SiteLayout>
